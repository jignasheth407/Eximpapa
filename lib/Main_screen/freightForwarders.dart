...
class freightforwarder extends StatefulWidget {
  @override
  //State<StatefulWidget> createState() {
  _freightforwarderState createState() => _freightforwarderState();
}

class _freightforwarderState extends State<freightforwarder> {
  ...
  var _scheduleSelected = ' Daily';
  String schedule = "";
  var _schedule = [' Daily', 'Weekly','Hourly'];

  var _loadingCapacity = ' 20ft';
  String loading = "";
  var _loading = [ ' 20ft','40ft',' high rise','other'];
                ...
                child: new Container(
                  child: new Column(
                    ...
                    children: <Widget>[
                      ...
                      new Text("Freight Forwarder",
                        style: TextStyle(
                            color: Colors.black,
                            fontSize: 24.0,
                            fontWeight: FontWeight.bold),),
                      Padding(padding: EdgeInsets.fromLTRB(30,0,30,10)),
                      Text("Freight Forwarder join as",
                        style: TextStyle(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            decoration: InputDecoration(
                              ...
                              // labelText: 'Enter Name Here',
                              hintText: 'Route from city to city with country',
                                hintStyle: TextStyle(fontSize: 14.0, ),
                                contentPadding: EdgeInsets.only(bottom: 10,top: 10,left: 10)
                            ),
                            autofocus: false,
                      ...
                      Padding(padding: EdgeInsets.only(right: 180,),
                        child: Text("Schedule",style: TextStyle(color: Colors.black54),),
                      ),
                      Padding(
                        padding: const EdgeInsets.fromLTRB(5, 0, 5, 5),
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                            // dropdownColor: Colors.grey,
                            isExpanded: true,
                            items: _schedule.map((String dropDawnStringItem) {
                              return DropdownMenuItem<String>(
                                value: dropDawnStringItem,
                                child: Text(dropDawnStringItem),
                              );
                            ...
                            onChanged: (String newValueSelected) =>
                                _onDropDownScheduleSelected(newValueSelected),
                            value: _scheduleSelected,
                          ),
                        ),
                      ),
                      Padding(padding: EdgeInsets.only(right: 135,),
                        child: Text("Loading Capacity",style: TextStyle(color: Colors.black54),),
                      ),
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                            // dropdownColor: Colors.grey,
                            isExpanded: true,
                            items: _loading.map((String dropDawnStringItem) {
                              return DropdownMenuItem<String>(
                                value: dropDawnStringItem,
                                child: Text(dropDawnStringItem),
                              );
                            ...
                            onChanged: (String newValueSelected) =>
                                _onDropDownLoadingSelected(newValueSelected),
                            value: _loadingCapacity,
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            decoration: InputDecoration(
                              ...
                              labelText: 'Approx price',
                              hintText: 'Offer typing space..',
                                hintStyle: TextStyle(fontSize: 14.0, ),
                                contentPadding: EdgeInsets.only(bottom: 10,top: 10,left: 10)
                            ),
                            autofocus: false,
  ...
  void _onDropDownScheduleSelected(String newValueSelected){
    setState(() {
      this._scheduleSelected =newValueSelected;
    });
  }
  void _onDropDownLoadingSelected(String newValueSelected){
    setState(() {
      this. _loadingCapacity = newValueSelected;
    });
  }
}
